...
export const env = createEnv({
  ...
  server: {
    ...
    NEXT_PUBLIC_WHATSAPP_RECIPIENT_WAID: z.string(),
    ...
    NEXT_PUBLIC_ZOHO_MAIL: z.string(),
  ...
  */
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_WHATSAPP_RECIPIENT_WAID: process.env.NEXT_PUBLIC_WHATSAPP_RECIPIENT_WAID,
