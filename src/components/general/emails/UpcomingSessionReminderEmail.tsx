...
interface UpcomingSessionReminderEmailProps {
  studentName: string;
  courseName: string;
  sessionDate: string;
  zoomJoinLink: string;
...
export const UpcomingSessionReminderEmail = ({
  studentName,
  courseName,
  sessionDate,
  zoomJoinLink,
  ...
  brandName1,
  brandName2,
}: UpcomingSessionReminderEmailProps & EmailSignatureProps) => (
  <Html>
    <Head />
    <Body style={main}>
      <Preview>Your upcoming session for {courseName} is starting soon!</Preview>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          This is a friendly reminder that your next session in <strong>{courseName}</strong> is scheduled for:
        </Text>

        <Text style={paragraph}>
          📅 <strong>Session Time:</strong> {sessionDate}
        </Text>
        ...
        <Text style={paragraph}>
          ✍️ Before the session begins, please complete this short quiz to help prepare:
        </Text>
        <Section style={btnContainer}>
...
export default UpcomingSessionReminderEmail;
