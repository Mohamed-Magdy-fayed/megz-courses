...
import WhatsappTemplatesClient from '@/components/admin/systemManagement/whatsAppTemplates/WhatsappTemplatesClient'
import WhatsAppTemplatesForm from '@/components/admin/systemManagement/whatsAppTemplates/WhatsAppTemplatesForm'
