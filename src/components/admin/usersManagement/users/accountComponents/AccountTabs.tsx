...
import AccountHistory from "@/components/admin/usersManagement/users/accountComponents/AccountHistory";
import AccountNotes from "@/components/admin/usersManagement/users/accountComponents/AccountNotes";
