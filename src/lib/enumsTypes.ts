...
export const validCourseStatuses = [CourseStatuses.cancelled, CourseStatuses.completed, CourseStatuses.ongoing, CourseStatuses.postponded, CourseStatuses.refunded, CourseStatuses.waiting, CourseStatuses.orderCreated, CourseStatuses.orderPaid] as const;
