import { CourseStatuses, Devices, EvaluationFormTypes, GroupStatus, OrderStatus, SalesOperationStatus, SessionStatus, TrainerRole, UserNoteTypes, UserType } from "@prisma/client";
