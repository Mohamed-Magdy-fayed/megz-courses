...
export const validCourseStatuses = [CourseStatuses.OrderCreated, CourseStatuses.OrderPaid, CourseStatuses.PlacementTest, CourseStatuses.Waiting, CourseStatuses.Ongoing, CourseStatuses.Completed, CourseStatuses.Postponded, CourseStatuses.Refunded, CourseStatuses.Cancelled] as const;
...
export const validDiscussionTypes = [DiscussionType.StudentTeacherOneToOne, DiscussionType.Group, DiscussionType.AdminPrivate] as const;
