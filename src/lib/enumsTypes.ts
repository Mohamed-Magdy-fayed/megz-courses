import { CourseLevels, Devices, GroupStatus, SalesOperationStatus, TrainerRole, UserType } from "@prisma/client";
...
export const validGroupStatuses = [GroupStatus.active, GroupStatus.cancelled, GroupStatus.inactive, GroupStatus.paused, GroupStatus.waiting] as const;
